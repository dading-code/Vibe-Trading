      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b">
          <div className="flex items-center gap-2">
            <span className="text-sm font-semibold">{t("pineScriptViewer.pineScriptV6")}</span>
            <span className="text-xs text-muted-foreground">{t("pineScriptViewer.strategyPine")}</span>
          </div>
          <div className="flex items-center gap-1.5">
            ...
            >
              ...
              {copied ? t("pineScriptViewer.copied") : t("pineScriptViewer.copy")}
            </button>
            <a
