...
PROJECT_DATA_DIR = AGENT_DIR / "data"

# .env search order: project/data/.env → agent/.env → $CWD/.env
_ENV_CANDIDATES = [
    PROJECT_DATA_DIR / ".env",
    AGENT_DIR / ".env",
    Path.cwd() / ".env",
]
...
# constants only.
_ENV_LABELS = ("<PROJECT_DATA>/.env", "<AGENT_DIR>/.env", "<CWD>/.env")
